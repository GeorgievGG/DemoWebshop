...
//        public async Task<string> PayWithCard(CheckoutModel order, double amount, Guid orderId, string aliasId, bool isNewAlias, bool saveAliasToDb, string authorizationMode)
//        {
//            try
//            {
//                CreatePaymentResponse response = await CreateIngenicoDirectClient()
//                                .WithNewMerchant(_checkoutConfiguration.MerchantId)
//                                .Payments
//                                .CreatePayment(BuildCC(order, amount, orderId, aliasId, isNewAlias, authorizationMode));
...
//                    Type = "Paid with CC",
//                    PaymentMethodId = GetPaymentMethodId().ToString(), //order.PaymentMethodId
...
//                if (saveAliasToDb)
//                {
//                    _checkoutContext.PersonTokens.Add(new PersonTokens
//                    {
//                        Email = "ceiddust@gmail.com",
//                        PaymentMethodId = GetPaymentMethodId().ToString(), //order.PaymentMethodId
//                        Token = aliasId,
//                        Name = response.Payment.PaymentOutput.CardPaymentMethodSpecificOutput.Card.CardNumber,
//                        ExpiryDate = order.CardDetails.ExpireDate,
//                        CustomerHolderName = order.CardDetails.CardName,
...
//        public async Task CapturePayment(string orderId, double amount)
//        {
//            try
//            {
...
//                    CaptureResponse response = await CreateIngenicoDirectClient()
//                    .WithNewMerchant(_checkoutConfiguration.MerchantId)
//                    .Payments
//                    .CapturePayment(paymentId, BuildCapture(amount));
...
//                        {
//                            Amount = amount,
//                            MerchantRef = response.CaptureOutput.References.MerchantReference,
...
//        {
//            PaymentResponse response = await CreateIngenicoDirectClient()
//                .WithNewMerchant(_checkoutConfiguration.MerchantId)
//                .Payments
...
//        private IClient CreateIngenicoDirectClient() => Factory.CreateClient(new Dictionary<string, string>() {
//                    { "direct.api.integrator", _checkoutConfiguration.MerchantId},
//                    { "direct.api.endpoint.host", _checkoutConfiguration.Host},
//                    { "direct.api.authorizationType", "v1HMAC"},
//                    { "direct.api.socketTimeout", "-1"},
//                    { "direct.api.connectTimeout", "-1"},
//                    { "direct.api.maxConnections", "100"}
//                    },
//                    _checkoutConfiguration.ApiKey,
//                    _checkoutConfiguration.ApiSecret);
...
//        private CapturePaymentRequest BuildCapture(double amount)
//        {
...
//        private Card BuildCard(CardDetailsModel card)
//        {
//            return new Card
//            {
