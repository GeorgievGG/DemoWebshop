        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingBaskets_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingBasketLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShoppingBasketLines_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingBasketLines_BasketId",
                table: "ShoppingBasketLines",
                column: "BasketId");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingBasketLines_ProductId",
                table: "ShoppingBasketLines",
                column: "ProductId");
