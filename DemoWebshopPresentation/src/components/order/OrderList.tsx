...
export const OrderList = () => {
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_SERVER_URL}/api/Order`, {
            method: 'GET',
            headers: {
  ...
  const confirmOrder = async (orderId: string) => {
    const response = await fetch(`${process.env.REACT_APP_SERVER_URL}/api/Order/${orderId}/ConfirmOrder`, {
            method: 'PUT',
            headers: {
  ...
  const setOrderDeliveryDate = async (orderId: string, deliveryDate: Date) => {
    const response = await fetch(`${process.env.REACT_APP_SERVER_URL}/api/Order/${orderId}/SetDeliveryDate`, {
            method: 'PUT',
            headers: {
                'Content-type': 'application/json',
                'Authorization': `Bearer ${sessionState.Token}`
